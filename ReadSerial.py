...
## August 21 2016 13:00 (Doug) Changed the loop to only take up to 60 seconds of data. Also added
##                             Printouts to show that data is being collectd.

## User defined parameters

FileLocal = 'C:/Users/madma_000/Dropbox/Projects/EricTempSensor/PythonRead/TempSense1.csv'
ArduinoPort1 = "COM10"
...
while count < 60: # only takes data for 60 seconds
...
print("Done...Connection Terminated")
